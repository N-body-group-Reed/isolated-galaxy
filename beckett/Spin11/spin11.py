...
N=2e4 #number of particles (should match sim)
...
pars={'a':10} 
sim = create_ics(profile = rho,drhodr=drhodr,d2rhodr2=d2rhodr2,fname = "noahgasnostars.out",m_vir='1e12 Msol', n_particles = 2e6,spin_parameter=.055)
# Increased spin parameter to 0.11.
