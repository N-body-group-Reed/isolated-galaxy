...
pars={'a':10} 
sim = create_ics(profile = rho,drhodr=drhodr,d2rhodr2=d2rhodr2,fname = "noahgasnostars.out",m_vir='1e11 Msol', n_particles = 2e6,spin_parameter=.1)
# Lowered m_vir to 1e11 Msol
