...
pars={'sig':10}
sim = create_ics(profile = rho,drhodr=drhodr,d2rhodr2=d2rhodr2,fname = "noahgasnostars.out",m_vir='1e12 Msol', n_particles = 2e4,spin_parameter=.1)
...
# particle count corrected to number used in noah's thesis
